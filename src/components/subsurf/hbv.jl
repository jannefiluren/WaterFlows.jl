...
function Hbv(tstep::Float64, time::DateTime)
    ...
    fc, lp, k0, k1, k2, beta, perc, ulz, maxbas = (100.0, 0.8, 0.05, 0.05, 0.01, 1.0, 2.0, 30.0, 2.5)
    ...
    return Hbv(
        sm, suz, slz, st_uh, ord_uh, fc, lp, k0, k1, k2, beta,
        perc, ulz, maxbas, p_in, epot, q_out, aevap, tstep, time
    )
